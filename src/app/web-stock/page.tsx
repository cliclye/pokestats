    ...
    <div className="flex min-h-full flex-col">
      ...
      <div className="px-5 pt-4 md:px-8">
        ...
        <p className="mt-2 max-w-2xl text-[var(--muted)]">
          Live sealed-product availability across Target, Walmart, Best Buy, GameStop, Pokémon
          Center, Amazon, and other tracked retailer sites. Filter by pack line, box type, or a
          specific product.
        </p>
      </div>
      <div className="mt-6">
